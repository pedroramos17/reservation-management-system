...
import { selectBookingById, getBookingsAsync } from '../bookings/bookingSlice';
            ...
            <Card variant="outlined">
              ...
              <CardActions sx={{ justifyContent: 'space-around' }}>
                <Button size="small" variant='outlined'>
                  <PDFDownloadLink document={<OrderDocument order={order} customer={customer} vehicle={vehicle} chargePer={chargePerText}/>} fileName={customer ? `${customer.name}-${order.id}.pdf` : 'document.pdf'} style={{ textDecoration: 'none' }}><Typography sx={[ (theme) => ({ color: theme.palette.text.primary, fontSize: '14px' })]}>Exportar PDF</Typography></PDFDownloadLink>
                </Button>
